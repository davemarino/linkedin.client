...
class LinkedIn(object):
    ...
    def get_company_search(self, parameters={}):
        """
        Use the Search API to find LinkedIn company profiles using keywords.
        This returns search results, which are an array of matching company profiles.
        Each matching profile is similar to a mini-profile popup view of LinkedIn
        member profiles.
